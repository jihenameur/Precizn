...
Route::group(['middleware' => ['jwt.verify']], function () {
    ...
    Route::get('getProductpubicByTagType', [ProductController::class, 'getProductpubicByTagType']);
    ...
    Route::get('getSubMenu/{id}', [MenuController::class, 'getSubMenu']);
    ...
    Route::post('createcommand', [CommandController::class, 'createCommand']);
